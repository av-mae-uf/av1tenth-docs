Route Representation and Vehicle Control
1.	Introduction
This document focuses on how a route is defined and on how a vehicle can navigate along this route.  The route data will be defined based on information obtained from Google Earth.  The document aims to detail the following:
